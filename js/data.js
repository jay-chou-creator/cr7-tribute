...
const CR7 = {
  ...
  stats: {
    club: {
      ...
      donut: [
        { label: "皇马", value: 54, color: "#C9A227" },
        { label: "曼联", value: 17, color: "#8A7130" },
        { label: "利雅得胜利", value: 16, color: "#5C6B3C" },
        { label: "尤文", value: 12, color: "#3A3F4A" },
        { label: "里斯本竞技", value: 1, color: "#2A2F38" }
      ],
      records: [
  ...
  bio: [
    {
      ...
      flip: false,
      paras: [
        "1985 年 2 月 5 日，C 罗出生在葡萄牙马德拉群岛的丰沙尔。父亲是园丁，母亲是清洁工，全家挤在屋顶漏雨的房子里。足球是他唯一的玩具，也是唯一的出路。",
        "12 岁那年，他离开母亲与故乡，独自前往里斯本竞技青训营。葡萄牙体育的青训教练们很快发现：这个瘦高的少年有着近乎病态的求胜欲——<span class=\"gold-key\">输掉任何一场训练赛，他都会愤怒到深夜加练</span>。",
        "1999 年，少年时代的心脏手术几乎终结他的足球梦。手术前母亲问他怕不怕，他说：<span class=\"gold-key\">“如果踢不了球，我活着还有什么意义？”</span>手术后仅四个月，他重返球场，从此再也没有停过。",
        "2002 年 10 月 7 日，17 岁的他代表里斯本竞技梅开二度；2003 年，弗格森在热身赛后当场拍板签下他。一个从大西洋小岛出发的故事，就此奔向世界之巅。"
      ]
    },
    {
      ...
      flip: true,
      paras: [
        "曼联的队友曾向媒体证实：C 罗总是第一个抵达训练基地、最后一个离开的人。弗格森爵士回忆道，2005 年世界杯后球队给他放假，他却打电话要求立刻回来加练身体。",
        "他的体脂率常年保持在 7% 左右，比多数职业球员低近一半；他每晚的睡眠、饮食、恢复计划精确到分钟。用他的话说：<span class=\"gold-key\">“天赋决定你的起点，勤奋决定你的终点。”</span>",
        "2016 年欧洲杯决赛，他在第 25 分钟被撞伤膝盖，含泪被换下。但他在场边化身教练，疯狂指挥队友——加时绝杀那一刻，他冲入场内与全队相拥。领袖不必永远在场上，但必须永远在战斗。",
        "从 2008 到 2017，五座金球奖横跨十年。这十年里，他与梅西的“绝代双骄”把足球的标准推到了前所未有的高度——而支撑这一切的，是每一天都不肯原谅自己的偏执。"
      ]
    },
    {
      ...
      flip: false,
      paras: [
        "他是全球社交媒体粉丝最多的运动员，但聚光灯外，他保持着惊人的朴素：为癌症患儿支付手术费、多次匿名献血、资助儿童医院重建。2015 年他捐出金球奖奖杯，拍卖所得 60 万欧元全部用于儿童慈善。",
        "商业上，他早已是一个完整的品牌：CR7 内衣、香水、酒店、健身与足球学院遍布全球。他说：<span class=\"gold-key\">“我踢球是为了热爱，但我也要为下一代铺路。”</span>",
        "他是一名父亲——四个孩子的父亲。无论凌晨几点结束比赛，他都会回家陪孩子吃早餐。乔治娜说，家里最神圣的时刻，是 C 罗陪孩子们玩积木。",
